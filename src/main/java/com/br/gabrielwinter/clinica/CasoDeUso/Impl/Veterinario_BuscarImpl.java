...
import com.br.gabrielwinter.clinica.CasoDeUso.Veterinario_Buscar;
...
@AllArgsConstructor
@Service
public class Veterinario_BuscarImpl implements Veterinario_Buscar {

    VeterinarioRepositoryGateway veterinarioRepositoryGateway;
    @Override
    public Veterinario exec(Veterinario veterinario) {
        return veterinarioRepositoryGateway.buscar(veterinario);
    }
}
